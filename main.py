...
def make_tale(frame_pa, music, bg, fg, leave_colo, row_x):
    def on_enter(event, music_info, index_framee, index, music_player_subtitle, music_title, music_artist, music_time):
    ...
    def on_leave(event, music_info, index_framee, index, music_player_subtitle, music_title, music_artist, music_time):
    ...
    music_info.bind("<Enter>",
                    lambda event, music_info=music_info, index_framee=index_framee, index=index,
                           music_player_subtitle=music_player_subtitle, music_title=music_title,
                           music_artist=music_artist, music_time=music_time:
                    on_enter(event, music_info, index_framee, index, music_player_subtitle, music_title,
                             music_artist, music_time))
    music_info.bind("<Leave>",
                    lambda event, music_info=music_info, index_framee=index_framee, index=index,
                           music_player_subtitle=music_player_subtitle, music_title=music_title,
                           music_artist=music_artist, music_time=music_time:
